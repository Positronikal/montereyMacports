...
# macports_monterey_upgrade.sh
# Hoyt Harness, 2021
#
# A shell script for macOS 12 Montery to upgrade an existing MacPorts
# installation for a previous version of macOS.
#
...
# Check for and/or create MacPorts dir:
...
echo "Reinstalling the MacPorts base system for Monterey..."
...
echo "MacPorts Monterey upgrade complete."
